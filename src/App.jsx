...
const systems = [
  { title: "S-300 / 1S91M3 Radar", subtitle: "Surveillance & Acquisition Radar", image: "/images/system-radar.jpg" },
  { title: "T-80 / T-90 Series", subtitle: "Main Battle Tanks", image: "/images/system-armor.jpg" },
  { title: "BMP-3", subtitle: "Infantry Fighting Vehicle", image: "/images/systems-collage.png" },
  { title: "Su-27 Family", subtitle: "Upgraded Variants", image: "/images/system-aircraft.jpg" },
  { title: "Mi-24 / Mi-35", subtitle: "Hind-Series Helicopters", image: "/images/system-aircraft.jpg" },
  { title: "Air Defense Systems", subtitle: "SAM Systems & Components", image: "/images/hero-radar.jpg" },
  { title: "Electronic Warfare Systems", subtitle: "EW Equipment & Components", image: "/images/system-electronics.jpg" },
  { title: "Components & Spares", subtitle: "Critical Parts & Subsystems", image: "/images/system-electronics.jpg" },
];

const siteStructure = [
  { icon: Home, title: "Home", text: "Overview and company positioning", path: "/" },
  { icon: ShieldCheck, title: "Capabilities", text: "Our procurement capabilities and approach", path: "/capabilities" },
  { icon: Target, title: "Systems of Interest", text: "Foreign-origin systems and technologies we support", path: "/systems" },
  { icon: ClipboardCheck, title: "Compliance / Contracting", text: "Government contracting, compliance, and legal framework", path: "/contracting" },
...
function Header({ page, navigate }) {
  return (
    <header className="site-header">
      ...
      <button className="nav-cta" onClick={() => navigate("/contact")}>Contact UAM</button>
    </header>
  );
}
        ...
        <div className="home-content">
          <div className="hero-copy-block">
            ...
            <div className="hero-actions">
              <button className="gold-button" onClick={() => navigate("/contact")}>Contact Procurement</button>
      ...
      <section className="structure-section">
        ...
        <div className="structure-grid">
          {siteStructure.map((item) => {
            const Icon = item.icon;
            return (
              <button key={item.path} className="structure-card" onClick={() => navigate(item.path)}>
                <Icon size={28} />
                <span>
    ...
    <section className="page-frame content-page">
      ...
      <div className="capability-grid">
        <FeatureCard icon={ShieldCheck} title="Foreign Materiel Procurement">
          Sourcing hard-to-procure foreign-origin military systems, components, and technologies for authorized U.S. Department of Defense research and evaluation requirements.
        </FeatureCard>
        <FeatureCard icon={Radar} title="Radar & Air Defense Focus">
          Specialized support for radar systems, air-defense platforms, associated components, and technical materiel relevant to testing, analysis, and exploitation programs.
        </FeatureCard>
        <FeatureCard icon={FileCheck2} title="Documentation & Compliance">
          Procurement activity is structured around lawful government requirements, documentation, sanctions compliance, export-control rules, and end-use controls.
        </FeatureCard>
        <FeatureCard icon={BriefcaseBusiness} title="Supplier Coordination">
          Support for locating sources, validating availability, coordinating communication, and preparing procurement-relevant information for authorized parties.
        </FeatureCard>
      </div>
    </section>
  );
  ...
  return (
    <section className="page-frame systems-page">
      <div className="page-heading compact">
        ...
        <p>
          UAM supports authorized procurement requirements involving foreign-origin military systems, components,
          and technologies for research, testing, evaluation, training, and analysis programs.
        </p>
      </div>
    ...
    <section className="page-frame content-page contact-page">
      ...
      <div className="contact-boxes">
        <a href="mailto:Dan.Zugrav@uam-inc.com">
          <Mail size={24} />
          <span><strong>Email</strong><em>Dan.Zugrav@uam-inc.com</em></span>
        </a>
        <a href="tel:+15618019030">
          <Phone size={24} />
          <span><strong>Phone</strong><em>+1 (561) 801-9030</em></span>
        </a>
        <div>
          <Building2 size={24} />
          <span><strong>Company</strong><em>United Acquisition Management, Inc.</em></span>
        </div>
        <div>
          <Globe2 size={24} />
          <span><strong>Website</strong><em>uam-inc.com</em></span>
        </div>
      </div>
    </section>
  );
...
function Footer() {
  return (
    <footer>
      © {new Date().getFullYear()} United Acquisition Management, Inc. All rights reserved. Real systems. Real capability. Authorized use only.
    </footer>
  );
}
